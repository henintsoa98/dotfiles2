;;; doom-henintsoa-theme.el --- modified from doom-Iosvkem
;;
;; Added: September 5, 2023
;; Author: Henintsoa <https://github.com/henintsoa98>
;; Maintainer: Henintsoa
;; Source: --
;;
;;; Commentary:
;;; Code:
...
(defgroup doom-henintsoa-theme nil
  "Options for the `doom-theme.el' theme."
  :group 'doom-themes)

(defcustom doom-henintsoa-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-henintsoa-theme
  :type 'boolean)

(defcustom doom-henintsoa-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-henintsoa-theme
  :type 'boolean)

(defcustom doom-henintsoa-comment-bg doom-henintsoa-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-henintsoa-theme
  :type 'boolean)

(defcustom doom-henintsoa-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-henintsoa
  "A dark theme inspired by VIM henintsoa"
  ...
  ((bg         '("#000000" "#000000" "#000000"))
   ...
   (selection      bg-alt)
   (builtin        magenta)
   (comments       (if doom-henintsoa-brighter-comments dark-cyan base6))
   (doc-comments   (doom-lighten (if doom-henintsoa-brighter-comments dark-cyan base6) 0.25))
   (constants      dark-cyan)
   (functions      red)
   (keywords       iopink)
   (methods        teal)
   ...
   (-modeline-bright doom-henintsoa-brighter-modeline)
   (-modeline-pad
    (when doom-henintsoa-padded-modeline
      (if (integerp doom-henintsoa-padded-modeline) doom-henintsoa-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if doom-henintsoa-comment-bg (doom-lighten bg 0.05))
    :slant 'italic)
...
;;; doom-henintsoa-theme.el ends here
